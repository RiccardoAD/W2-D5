...
const primoPosto=pets2.shift();
 pets2.push(primoPosto);
console.log("esercizio 4 ", pets2);
...
const licensePlate=["GA124K","SD567J","EZ342P"]
...
console.log("eserzio 7 ",justTrims);
/* ESERCIZIO 8
...
*/
 for (let i = 0; i < cars.length; i++) {
   if( cars[i].color.startsWith("b")==true){
     console.log("ES 7 frizz");


   } else {
    console.log("ES 7 Buzz");
   }
